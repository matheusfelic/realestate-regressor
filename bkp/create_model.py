...
train = train.drop(['id','timestamp','url','month','operation','bathrooms','ensuites'],axis=1)
test = test.drop(['id','timestamp','url','month','operation','bathrooms','ensuites'],axis=1)
...
train_sample = train.sample(n=50000, random_state=2)

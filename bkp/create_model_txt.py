...
#metrics for txt RF
r_mle_rf = mean_log_error(regr.predict(X_txt_test), y_test_csv)
r_mape_rf = mean_absolute_percentage_error(regr.predict(X_txt_test), y_test_csv)
...
#metrics for txt SVM
r_mle_svm = mean_log_error(svm.predict(X_txt_test), y_test_csv)
r_mape_svm = mean_absolute_percentage_error(svm.predict(X_txt_test), y_test_csv)
...
#metrics for txt XGB
r_mle_xgb = mean_log_error(xgboost.predict(X_txt_test), y_test_csv)
r_mape_xgb = mean_absolute_percentage_error(xgboost.predict(X_txt_test), y_test_csv)
